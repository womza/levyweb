<?php $model = new Slzexploore_Core_Cruise(); ?>
<div class="find-widget find-cruises-widget widget">
	<h4 class="title-widgets"><?php esc_html_e( 'FIND CRUISES', 'slzexploore-core' ) ?></h4>
		...
		<div class="text-input small-margin-top">
			<div class="place text-box-wrapper">
				...
				<?php
					...
					$location         = Slzexploore_Core_Com::get_tax_options2name( 'slzexploore_cruise_location',
			...
			<div class="place text-box-wrapper">
				...
				<?php
					...
					$arr_cats    = Slzexploore_Core_Com::get_tax_options2name( 'slzexploore_cruise_cat', $cat_empty, $cat_args );
			...
			<button type="submit" name="search-cruise" value="1" data-hover="<?php esc_html_e( 'SEARCH NOW', 'slzexploore-core' ); ?>" class="btn btn-slide <?php if( $style == '02' ) echo 'small-margin-top'; ?>"><span class="text"><?php esc_html_e( 'SEARCH', 'slzexploore-core' ); ?></span><span class="icons fa fa-long-arrow-right"></span></button>
		</div>
	</form>
</div>