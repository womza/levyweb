...
vc_map(array(
	'name'               => esc_html__( 'SLZ Search Hotel', 'slzexploore-core' ),
	'base'               => 'slzexploore_core_accommodation_search_sc',
	'class'              => 'slzexploore_core-sc',
	'icon'               => 'icon-slzexploore_core_accommodation_search_sc',
	'category'           => SLZEXPLOORE_CORE_SC_CATEGORY,
	'description'        => esc_html__( 'A accomodation search form.', 'slzexploore-core' ),
	'params'             => $params
	)
);