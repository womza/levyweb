...
vc_map(array(
	'name'               => esc_html__( 'SLZ Search Tour', 'slzexploore-core' ),
	'base'               => 'slzexploore_core_tour_search_sc',
	'class'              => 'slzexploore_core-sc',
	'icon'               => 'icon-slzexploore_core_tour_search_sc',
	'category'           => SLZEXPLOORE_CORE_SC_CATEGORY,
	'description'        => esc_html__( 'A tour search form.', 'slzexploore-core' ),
	'params'             => $params
	)
);